...
declare function pid_init {
  ...
  declare P to 0.     // phenomenon P being affected.
  declare I to 0.     // crude approximation of Integral of P.
  declare D to 0.     // crude approximation of Derivative of P.
  declare oldT to -1. // (old time) start value flags the fact that it hasn't been calculated
  declare oldInput to 0. // previous return value of PID controller.
...
declare function pid_seek {
  ...
  declare oldT to pid_array[7]. // Old Time
  declare oldInput to pid_array[8]. // prev return value, just in case we have to do nothing and return it again.

  declare P to seekVal - curVal.
  declare D to 0. // default if we do no work this time.
  declare I to 0. // default if we do no work this time.
  declare newInput to oldInput. // default if we do no work this time.
